...
def res_mlp_block(inputs, channels_mlp_dim, drop_rate=0, activation="swish", name=None):
...
def ResMLP12_teacher(input_shape=(224, 224, 3), num_classes=1000, activation="swish", classifier_activation="softmax", pretrained="imagenet", **kwargs):
